...
const sub = quiz_box.querySelector("footer .next_btn");
...
function showResultBox() {
    ...
    if (userScore > 3) {
        let scoreTag = '<span>you got <p>' + userScore + '</p> out of <p>' + questions.length + '</p>, You are selected</span>';
        scoreText.innerHTML = scoreTag;
        userScore = 0;
    }
    else {
        let scoreTag = '<span>you got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p>, You are not Selected</span>';
        scoreText.innerHTML = scoreTag;
        userScore = 0;
    }
}
